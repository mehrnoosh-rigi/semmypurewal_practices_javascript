...
//     //=> false
//
var containsTwice = function (number , array) {
	result = false
...
//     //=> false
//
var containsNTimes = function (number, value, array) {
	count = 0 ;
	for (var i = 0 ; i < array.length ; i++){
		if (array[i] === number){
			count ++
...
var containsAnyTwice = function (array1, array2) {
	...
	if (Array.isArray(array1) && Array.isArray(array2)){
		for (var i = 0 ; i < array1.length ; i++){
			if (containsTwice(array1[i], array2)
				result = true
		}
	}
	else
...
//     //=> []
//
var getValuesAppearingTwice = function (array1, array2) {
	if (Array.isArray(array1) && Array.isArray(array2)){
		for (var i = 0 ; i < array1.length ; i++){
			if (containsTwice(array1[i], array2){
				array3.push[index] = array1[i]
				index++
			}
